 ...
 * Get Cart Route
 */
export const cartGetCartRoute = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
 ...
 */
export const cartCreateCartRoute = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<CartCreateCartRouteResponse, CartCreateCartRouteError, ThrowOnError>({
        ...options,
        url: '/api/cart/'
    });
};
