...
export const cartChangeItemQuantityRoute = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CartChangeItemQuantityRouteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<CartChangeItemQuantityRouteResponse, CartChangeItemQuantityRouteError, ThrowOnError>({
        ...options,
...
/**
 * Remove Item Cart Route
 * Route to change quantity of item in cart
 */
export const cartRemoveItemCartRoute = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CartRemoveItemCartRouteData, ThrowOnError>) => {
    return (options?.client ?? client).put<CartRemoveItemCartRouteResponse, CartRemoveItemCartRouteError, ThrowOnError>({
        ...options,
