 ...
 * Process order route
 */
export const adminProcessOrderRoute = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AdminProcessOrderRouteData, ThrowOnError>) => {
    return (options?.client ?? client).post<AdminProcessOrderRouteResponse, AdminProcessOrderRouteError, ThrowOnError>({
        ...options,
        url: '/api/admin/order/{order_id}/process'
    });
};
 ...
 * Stop Process order route
 */
export const adminStopProcessOrderRoute = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AdminStopProcessOrderRouteData, ThrowOnError>) => {
    return (options?.client ?? client).post<AdminStopProcessOrderRouteResponse, AdminStopProcessOrderRouteError, ThrowOnError>({
        ...options,
        url: '/api/admin/order/{order_id}/cancel-processing'
    });
};

/**
 * Is Order Processing Route
 */
export const adminIsOrderProcessingRoute = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AdminIsOrderProcessingRouteData, ThrowOnError>) => {
    return (options?.client ?? client).get<AdminIsOrderProcessingRouteResponse, AdminIsOrderProcessingRouteError, ThrowOnError>({
        ...options,
        url: '/api/admin/order/{order_id}/is-processing'
    });
};
